...
#endif
{
...
#if 0
  {
    ...
    dimacs_graph (graph_ofile, bt, domsz);
  }
#endif
  {
    FlatDigraph digraph;
    Cx::BitTable min_bt;
#if 0
    flat_canonical_digraph(digraph, min_bt, bt, domsz);
    flat_canonical_hack(digraph, min_bt);
#else
    canonical_set(min_bt, bt, domsz);
