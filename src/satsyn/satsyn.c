...
#include "inst-sat3.h"
#include "inst-matching.h"
#include "inst-coloring.h"
#include "inst-bit3.h"
#include "inst-dijkstra.h"
#include "inst-dijkstra4state.h"
