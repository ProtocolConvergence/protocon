...
future silent;
\end{code}
We use this in the \ilfile{examplespec/OrientRing.prot} example where the invariant is defined as \ilcode{(future & shadow) (I);}.
...
\end{code}
We use this in the \ilfile{examplespec/TokenRingSixState.prot} where the invariant is defined as \ilcode{(future & shadow) (I);}.
In this case, we desire an active shadow protocol, but the two alternative ways to define the invariant have deficiencies:
