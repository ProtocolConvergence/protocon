...
(define-fun act_P ((x_pd Int) (x Int) (x_sc Int) (x1 Int)) Bool
  (or
    (and      (= x_pd 0)  (not (= x 1))        (= x_sc 2)  (= x1 1))
    (and (not (= x_pd 0))      (= x 2)         (= x_sc 2)  (= x1 0))
    (and      (= x_pd 2)       (= x 1)         (= x_sc 1)  (= x1 0))
    (and (not (= x_pd 2))      (= x x_pd) (not (= x_sc 2)) (= x1 2))
    (and (not (= x_pd 2))      (= x x_sc) (not (= x_sc 2)) (= x1 2))
    )
  )

(define-fun legit_P ((x_pd Int) (x Int) (x_sc Int)) Bool
  (not (or (= x_pd x) (= x x_sc))))
  ;(not (= x_pd x)))
