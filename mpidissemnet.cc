...
MpiDissemNet::MpiDissemNet(uint _PcIdx, uint NPcs, int _tag, MPI_Comm _comm)
  : done(false)
  , term(false)
  , value(-1)
  , tag(_tag)
  ...
  , PcIdx(_PcIdx)
{
  ...
  void
MpiDissemNet::handle_recv(uint i)
{
  ...
  void
MpiDissemNet::handle_send(uint i)
{
...
MpiDissemNet::terminate()
{
  ...
  void
MpiDissemNet::done_fo()
{
  this->done = true;
}

  bool
MpiDissemNet::done_ck()
{
  return done;
}
